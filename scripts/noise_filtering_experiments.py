...
print("test: ", np.abs(grain_fft).sum())
print("test: ", inv_cepstral_coeff.sum())
...
sig_noise_fft_mfcc = grain_fft / (inv_mfccs + 1e-7)
...
print("test: ", sig_noise_cc.sum())
print("test2: ", sig_noise_mfcc.sum())

# print("TEST: ", sig_noise_mfcc.sum())

# plt.plot(sig_DivSpecShape[7])
# plt.plot(sig_noise_mfcc[7])
# plt.figure()
...
audio = dsp.fft_convolve_no_pad_2(sig_noise_mfcc, inv_mfccs)
